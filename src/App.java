...
public class App {
    public static void main(String[] args) throws Exception {
        int cantidadEstudiantes = 60_000_000; // 200 mil estudiantes "1 forma de escribir numeros "
        int cantidadConsultas = 40_000; // 40 mil consultas "2 forma de escribir numeros "
